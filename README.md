  ...
  <tr>
    ...
    <td style="padding: 20px;">
      <div style="position: relative;">
        <img src="assets/gif/gif.gif" alt="Profile GIF" style="position: absolute; bottom: 0; right: 0; max-height: 200px; width: auto; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/>
      </div>
    </td>
  </tr>
</table>
