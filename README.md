      ...
      <tr>
        ...
        <td width="50%" style="padding: 10px; background-color: #0d1117; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
          <div style="text-align: center; padding: 10px;">
            ...
            <a href="https://github.com/NareshRana1999">
              <img height="160" src="https://github-readme-stats.vercel.app/api/wakatime?username=NareshRana1999&theme=radical&hide_border=true&layout=compact" alt="Coding Activity" style="width: 100%; border-radius: 6px;" />
            </a>
          </div>
        </td>
      </tr>
